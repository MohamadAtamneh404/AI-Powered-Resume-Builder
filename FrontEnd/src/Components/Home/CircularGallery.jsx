...
import modernProfessionalImg from "./data/ModernProfessional.png";
import classicElegantImg from "./data/ClassicElegant.png";
import creativeBoldImg from "./data/CreativeBold.png";
import minimalCleanImg from "./data/MinimalClean.png";
import darkVisionImg from "./data/DarkVision.png";
import neoElegantImg from "./data/NeoElegant.png";
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      ...
      {
        image: classicElegantImg,
        text: "Classic Elegant",
      },
      {
        image: creativeBoldImg,
        text: "Creative Bold",
      },
      {
        image: minimalCleanImg,
        text: "Minimal Clean",
      },
      {
        image: darkVisionImg,
...
export default function CircularGallery({
  ...
  return (
    <div
      className="w-full h-full min-h-[460px] overflow-hidden cursor-grab active:cursor-grabbing relative"
      ref={containerRef}
    />
  );
}
